...
public:
	...
	double& data(const Eigen::Vector3i& i){return data_[i[0]*n_[1]*n_[2]+i[1]*n_[2]+i[2]];}
	const double& data(const Eigen::Vector3i& i)const{return data_[i[0]*n_[1]*n_[2]+i[1]*n_[2]+i[2]];}
